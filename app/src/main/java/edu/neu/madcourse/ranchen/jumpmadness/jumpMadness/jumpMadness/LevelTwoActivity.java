...
/**
 * Created by cheerhou on 4/19/16.
 */
public class LevelTwoActivity extends Activity {
    public static final String TAG = "LevelTwo";
    ...
    private MediaPlayer brickIntroPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        brickIntroPlayer = MediaPlayer.create(this, R.raw.brick_intro);
        brickIntroPlayer.setLooping(false);
        brickIntroPlayer.setVolume(1.0f, 1.0f);
    ...
    protected void onStart() {
        ...
        brickIntroPlayer.start();
        brickIntroPlayer.setOnCompletionListener(
    ...
    public class GameCountDownTimer extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            if(jumpCount > 5) {
                ...
                getSharedPreferences(PREFS_NAME, MODE_PRIVATE).edit().putBoolean("levelTwoPass", true).commit();
                //show next button
