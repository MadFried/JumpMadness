...
public class WalkthroughActivity extends Activity {
    ...
    class WalkthroughPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(View container, int position) {
            ...
            switch(position) {
                case 0:
                    imageView.setImageResource(R.drawable.hold_device);
                    break;

                case 1:
                    imageView.setImageResource(R.drawable.jump_tutorial);
                    break;

                case 2:
                    imageView.setImageResource(R.drawable.fire_tutorial);
                    break;
            }
