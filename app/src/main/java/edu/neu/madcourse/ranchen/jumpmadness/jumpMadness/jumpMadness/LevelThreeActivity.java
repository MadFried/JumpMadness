...
public class LevelThreeActivity extends Activity {
    public static final String TAG = "LevelThree";
    ...
    private MediaPlayer coinIntroPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coinIntroPlayer = MediaPlayer.create(this, R.raw.coin_intro);
        coinIntroPlayer.setLooping(false);
        coinIntroPlayer.setVolume(1.0f, 1.0f);
    ...
    protected void onStart() {
        ...
        coinIntroPlayer.start();
        coinIntroPlayer.setOnCompletionListener(
    ...
    public class GameCountDownTimer extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            if(jumpCount > 5) {
                ...
                getSharedPreferences(PREFS_NAME, MODE_PRIVATE).edit().putBoolean("levelThreePass", true).commit();
